...
export const create = async (req, res, next) => {
  try {
    ...
    const {
      ...
      gv1_presion, gv1_pres_qnt, gv1_temp, gv1_temp_ti_vc, gv1_pres_vapor, gv1_temp_vapor, gv1_temp_tubo, gv1_temp_chimenea, gv1_calidad, gv1_flujo_agua, gv1_flujo_gas, gv1_inyectado,
      gv3_presion, gv3_pres_qnt, gv3_temp, gv3_temp_ti_vc, gv3_pres_vapor, gv3_temp_vapor, gv3_temp_tubo, gv3_temp_chimenea, gv3_calidad, gv3_flujo_agua, gv3_flujo_gas, gv3_inyectado,
    ...
    const newLog = {
      ...
      gv1_pres_pi_vc: req.body.gv1_pres_pi_vc ?? null,
      gv1_pres_pit_vc: req.body.gv1_pres_pit_vc ?? null,
      gv1_temp_ti_vc: req.body.gv1_temp_ti_vc ?? null,
      gv1_pres_vapor: req.body.gv1_pres_vapor ?? null,
      ...
      gv3_pres_pi_vc: req.body.gv3_pres_pi_vc ?? null,
      gv3_pres_pit_vc: req.body.gv3_pres_pit_vc ?? null,
      gv3_temp_ti_vc: req.body.gv3_temp_ti_vc ?? null,
      gv3_pres_vapor: req.body.gv3_pres_vapor ?? null,
